...
/**
 * Small inline icon set for form controls, standing in for lucide (Search,
 * X, Eye/EyeOff, ChevronDown, Check) until real iconography is provided —
 * same substitution the Claude Design mockup used for Button's "menu" glyph.
 */
...
export function EyeIcon({ size = 16, off = false }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      {off ? (
        <React.Fragment>
...
export function ChevronDownIcon({ size = 16, open = false }) {
  return (
    <svg
      width={size}
      height={size}
